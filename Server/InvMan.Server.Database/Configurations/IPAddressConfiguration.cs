...
namespace InvMan.Server.Database.Configurations
{
	public class IPAddressConfiguration : IEntityTypeConfiguration<IPAddress>
	{
		public void Configure(EntityTypeBuilder<IPAddress> builder)
		{
			...
			builder.HasData(
				new IPAddress { ID = 1, Address = "198.22.33.1" },
				new IPAddress { ID = 2, Address = "198.22.33.2" },
				new IPAddress { ID = 3, Address = "198.22.33.3" },
				new IPAddress { ID = 4, Address = "198.22.33.4" },
				new IPAddress { ID = 5, Address = "198.22.33.5" },
				new IPAddress { ID = 6, Address = "198.22.33.6" },
				new IPAddress { ID = 7, Address = "198.22.33.7" },
				new IPAddress { ID = 8, Address = "198.22.33.8" },
				new IPAddress { ID = 9, Address = "198.22.33.9" },
				new IPAddress { ID = 10, Address = "198.22.33.10" },
